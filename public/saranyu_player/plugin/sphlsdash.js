...
SaranyuHlsHTML5Player.MediaPlayer.prototype = {
		...
		_createFullControls : function(){
			...
			var bottomProgressBar = '<div class="sp-controls-bottom-progress-bar1"></div>';
			t.fullControls.bottomControlBar.append(bottomProgressBar);
			t.fullControls.bottomControlBar.bottomProgressBar = t.fullControls.find('.sp-controls-bottom-progress-bar1');
		...
		_createAndAppendHLStoPlayer : function(file){
				...
				t._createAndAppendHLStoPlayer._attachHLStoVideo = function (){
					...
					if(Hls.isSupported()){
					    ...
					    //t.mediaElement.videoElement.hlsObjConfig = {liveMaxLatencyDurationCount: 5};
					    //t.mediaElement.videoElement.hlsObj = new Hls(t.mediaElement.videoElement.hlsObjConfig);
					    ...
					    t.mediaElement.videoElement.hlsObj.on(Hls.Events.ERROR,function(data,data2){
					    		try{
					    			console.log('on error');
					    			console.log(data);
					    			console.log(data2);
					    			t.eventcallbacks.onError(data2.details);
					    		}catch(e){					    			
					    		}					    	
					    });
		...
		_buildprogressbar : function(){
			...
			var progressbar = '<div class="sp-controls-bottom-progress-bar"><div class="sp-progress-bar-time-rail"><span class="sp-progress-bar-buffering"></span><span class="sp-progress-bar-loaded"></span><span class="sp-progress-bar-current"></span><span class="sp-progress-bar-cues"></span><span class="sp-progress-bar-handle"></span><span class="sp-progress-bar-timefloat"></span><span class="sp-progress-bar-seekbar-preview"></span></div></div>';
			t.fullControls.bottomControlBar.bottomPlayerControls.append(progressbar);
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-time-rail');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.buffering = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-buffering');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.loaded = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-loaded');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.current = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-current');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-handle');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-timefloat');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-seekbar-preview');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.cues = t.fullControls.bottomControlBar.bottomPlayerControls.find('.sp-progress-bar-cues');
			...
			t._buildprogressbar.adjustCurrentAndHandleInSeek = function(percentage){
				...
				var offsets = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.width()/2;
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.current.width(percentageWithSpecialChar);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.css("left","calc("+percentageWithSpecialChar+" - "+offsets+"px)");
				...
				var ptl,ptw;
				var percentage2 = 0;
				thl = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.offset().left;
				thw = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.width();

				ptl = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.offset().left;
				ptw = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.width();

				if(thl<ptl){
					//if timer handler is outside of extreme left end
					var temp = 0;				
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.css('left', temp+"px" );
				}
					...
					temp = ptw - thw;
					percentage2 = temp;
					offsets = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.width();
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.css("left","calc("+percentageWithSpecialChar+" - "+offsets+"px)");
				}
			...
			function showToolTip(e){
				...
				var seekTotal = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar, totalOffset = seekTotal.offset();
				...
				if(newTime<0 || newTime>media.duration || isNaN(newTime)){
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.show();
					return;
				}

				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.html(SaranyuHlsHTML5Player.Utils.secondsToTimeCode(newTime));
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.css("left",percentageWithSpecialChar);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.show();

				var tfl,tfw;
				var ptl,ptw;
				var percentage2 = 0;
				tfl = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.offset().left;
				tfw = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.outerWidth();

				ptl = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.offset().left;
				ptw = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.outerWidth();

				if((tfw+tfl)>(ptl+ptw)){
					var temp;
					temp = ptw - tfw;
					percentage2 = temp;
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.css('left', percentage2+"px" );
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.show();
				}

				try{
					if(t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates.thumbnailsMetaData){
						t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.renderingThumbnailPreview(newTime);
						t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.css("left",percentageWithSpecialChar);
						t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.show();

						var sbl,sbw;
						var percentage3 = 0;
						sbl = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.offset().left;
						sbw = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.outerWidth();

						if((sbw+sbl)>(ptl+ptw)){
							var temp2;
							temp2 = ptw - sbw;
							percentage3 = temp2;
							t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.css('left', percentage3+"px" );
							t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.show();
						}
			...
			function hideToolTip(){
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.timefloat.hide();
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.hide();
			}
			...
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.bind('mouseover', function(e) {
				showToolTip(e);
				e = SaranyuHlsHTML5Player.Utils.preventSelectionOfTextInMouseMove(e);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.mouseIsOver = true;
			}).bind('mousemove', function(e) {
				showToolTip(e);
				e = SaranyuHlsHTML5Player.Utils.preventSelectionOfTextInMouseMove(e);
				if (t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.mouseIsDown == true) {
					handleSeekBarMove(e);
				}
			}).bind('mouseup', function(e) {
				e = SaranyuHlsHTML5Player.Utils.preventSelectionOfTextInMouseMove(e);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.mouseIsDown = false;
			}).bind('mousedown', function(e) {
				e = SaranyuHlsHTML5Player.Utils.preventSelectionOfTextInMouseMove(e);
					handleSeekBarMove(e);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.mouseIsDown = true;
			}).bind('mouseleave', function(e) {
				hideToolTip();
				e = SaranyuHlsHTML5Player.Utils.preventSelectionOfTextInMouseMove(e);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.mouseIsDown = false;
			...
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.saranyuHammer({
				drag_max_touches : 0
				...
				for ( var i = 0, len = touches.length; i < len; i++) {
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.mouseIsDown = true;
					handleSeekBarMove(touches[i]);
				}
			}).on("release", function(ev) {
				handleSeekBarMove(ev);
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.handle.mouseIsDown = false;
				hideToolTip();
			...
			function showBufferedData(bufferedMaxTimePercentage){
				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.loaded.width(bufferedMaxTimePercentage*100+"%");
			}
		...
		_buildseekbarpreview : function(){
			...
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.append(seekbarPreviewContainerImgTag);

			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.seekbarPreviewContainerImgTag = t.fullControls.bottomControlBar.bottomProgressBar.progressbar.seekbarPreviewContainer.find('.sp-progress-bar-seekbar-preview-img');
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates = function(thubmnailsVttAjaxResponse){

				t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates.thumbnailsMetaData = [];
				...
				if(thubmnailsVttAjaxResponse != ''){
				    ...
				    $.each(items,function(index,value) {
						...
						if((item[1] != undefined) && (item[1] != '') && (item[1].toLowerCase() != "webvtt")){
							 ...
							 t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates.thumbnailsMetaData.push(ImgMetaData);
						}
					  });
			...
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.ajaxForVtt = function(vttURL){

					//kill the request
					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.ajaxForVtt.abort = function(){
						t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.ajax.abort();
					};

					//abort the ajax call before initiating new one
					try{
						t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.ajaxForVtt.abort();
					}catch(e){
					}

					t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.ajax =  $.ajax({
						    type: "GET",
						    url: vttURL,
					}).done(function(msg){
							//console.log( "Data Saved: " + msg );
							t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates(msg);
					}.bind(t));

			};

			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.renderingThumbnailPreview = function(time){
				//get appropriate thumbnail and its position for given seek time
				if(t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates.thumbnailsMetaData.length > 1){
					$.each(t.fullControls.bottomControlBar.bottomProgressBar.progressbar.seekbarPreviewContainer.parseAndCalculateCordinates.thumbnailsMetaData,function(index,value){
						if(time >= value.startTime && time <= value.endTime){
							$(t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.seekbarPreviewContainerImgTag).attr("src",value.imgSrc);
							$(t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.seekbarPreviewContainerImgTag).css("height",value.imgHeight);
							$(t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.seekbarPreviewContainerImgTag).css("width",value.imgWidth);
							$(t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.seekbarPreviewContainerImgTag).css("object-position",value.imgxPos +" "+ value.imgyPos);
						}
					});
				}
			}
			// start the seekbar preview calculation
			t.fullControls.bottomControlBar.bottomPlayerControls.progressbar.seekbarPreviewContainer.ajaxForVtt(t.options.file[0].thumbnails);
		},
		...
		_buildqualityswitch : function(){
			...
			var media = t.mediaElement.videoElement;
			var options = t.options;
			var quality = '<div class="sp-button sp-quality-switch sp-quality-switch-wrap"><button class="sp-quality-switch-btn"></button><div class="sp-quality-switch-wrap sp-quality-switch-popup-wrap"></div></div>';
				...
				if(levelinfo.length > 1){
					...
					if(t.playerType == "mpd"){
						$.each(levelinfo,function(index,value){
							...
							if(t.options.qualityswitch.metric == "both"){
								selectOptions += "<div><button class="+classInactive+" type='button' label="+label+" index="+t.mediaElement.videoElement.dashObj.bitratez[index].qualityIndex+">"+resolution+"&nbsp;/&nbsp;"+label+"</button></div>" ;
							}							
							else if(t.options.qualityswitch.metric == "resolution"){
							...
							if(t.options.qualityswitch.metric == "both"){
								selectOptions += "<div class="+classInactive+"><button class="+classInactive+" type='button' label="+label+" index="+index+">"+label+" kbps / "+resolution+"</button></div>" ;
							}
							else if(t.options.qualityswitch.metric == "resolution")
							{
		...
		_buildrelatedvideo : function(boolz){
			...
			if(t.fullControls.relatedPanel.boolz){
				t.fullControls.relatedPanel.relatedVideosDisplayTimerCount = 10;	
			}else{
		...
		*/
		//create and append Back Arrow in top controls bar

		_buildbackarrow : function(){
			SaranyuHlsHTML5Player.Utils.DLOG("Attaching Back Arrow");
			var t = this;
			var backarrow = '<div class="sp-button sp-backarrow"><span class="tooltiptext"></span><button class="sp-backarrow-btn"></button></div>';
			t.fullControls.topContolbar.append(backarrow);
			t.fullControls.topContolbar.backarrow = t.fullControls.topContolbar.find('sp-button sp-backarrow');
			t.fullControls.topContolbar.backarrow.goBack = function(){
		  //t.fullControls.topContolbar.videoTitle.html(title);
			}.bind(t);			
		},


		//create and append Share in top controls bar

		_buildshare : function(){
			SaranyuHlsHTML5Player.Utils.DLOG("Attaching Share icon");
			var t = this;
			var share = '<div class="sp-button sp-share"><span class="tooltiptext"></span><button class="sp-share-btn"></button></div>';
			t.fullControls.topContolbar.append(share);
			t.fullControls.topContolbar.share = t.fullControls.topContolbar.find('sp-button sp-share');
			t.fullControls.topContolbar.share.shareVideo = function(){
				//t.fullControls.topContolbar.videoTitle.html(title);
			}.bind(t);			
		},

		//create and append Favourite in top controls bar

		_buildfavourite : function(){
			SaranyuHlsHTML5Player.Utils.DLOG("Attaching Favourite icon");
			var t = this;
			var favourite = '<div class="sp-button sp-favourite"><span class="tooltiptext"></span><button class="sp-backarrow-btn"></button></div>';
			t.fullControls.topContolbar.append(favourite);
			t.fullControls.topContolbar.favourite = t.fullControls.topContolbar.find('sp-button sp-favourite');
			t.fullControls.topContolbar.favourite.favouriteVideo = function(){
				//t.fullControls.topContolbar.videoTitle.html(title);
			}.bind(t);			
		},


		//create and append Comments in top controls bar

		_buildcomment : function(){
			SaranyuHlsHTML5Player.Utils.DLOG("Attaching Comments icon");
			var t = this;
			var comment = '<div class="sp-button sp-comment"><span class="tooltiptext"></span><button class="sp-comment-btn"></button></div>';
			t.fullControls.topContolbar.append(comment);
			t.fullControls.topContolbar.comment = t.fullControls.topContolbar.find('sp-button sp-comment');
			t.fullControls.topContolbar.comment.commentVideo = function(){
				//t.fullControls.topContolbar.videoTitle.html(title);
			}.bind(t);			
		},
		...
		_videoPlayerControls : function(operation,value){
			...
			switch (operation){
				case "play":
					...
					if(t.playerType === "hls" && t.mediaElement.videoElement.duration === 0){
						t._createAndAppendHLStoPlayer._attachHLStoVideo();
					}else{
						media.play();	
					}					
